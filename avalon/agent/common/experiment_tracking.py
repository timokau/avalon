...
class TrackerBackend:
    ...
    def download_file(self, run_id: str, project_name: str, filename: Optional[str] = None) -> str:
        raise NotImplementedError()
...
class ExperimentTracker:
    ...
    def log_from_queue(self, wandb_queue, prefix: str = ""):  # type: ignore
    ...
    def download_file(self, run_id: str, project_name: str, filename: Optional[str] = None) -> str:
        return self.tracker_backend.download_file(run_id, project_name, filename)
